 ...
 */
public class CommentModel extends AbstractJSONRequestModel {
    ...
    protected JsonObject toJson() {
        ...
        json.addProperty(Requester.ParameterKey.COMMENT, this.comment);
        return json;
    }

    @Override
    protected IRequest.Type getRequestType() {
        return IRequest.Type.ACTION_COMMENT;
    }
