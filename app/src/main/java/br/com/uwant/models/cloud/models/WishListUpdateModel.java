...
public class WishListUpdateModel extends AbstractJSONRequestModel {
    ...
    protected JsonObject toJson() {
        ...
        jsonObject.add(Requester.ParameterKey.PRODUCTS, WishListUtil.listProductsToJson(Type.INSERT, mUpdateProducts.get(Type.INSERT)));
        jsonObject.add(Requester.ParameterKey.PRODUCTS_REMOVED, WishListUtil.listProductsToJson(Type.DELETE, mUpdateProducts.get(Type.DELETE)));
        return jsonObject;
    }
